...
apt-get update && apt-get install simplesamlphp php-xml php-curl php-mbstring php-memcache
...
a2enmod ssl
cp ./apache.conf /etc/simplesamlphp/apache.conf
...
echo "Test the default-sp authentication source here: https://$HOSTNAME/simplesamlphp/module.php/core/authenticate.php"
echo "Test IdP-initiated login here: https://$HOSTNAME/simplesamlphp/saml2/idp/SSOService.php?spentityid=https://$HOSTNAME/simplesamlphp/module.php/saml/sp/metadata.php/default-sp&RelayState=https://$HOSTNAME/simplesamlphp/module.php/core/authenticate.php?as=default-sp"
